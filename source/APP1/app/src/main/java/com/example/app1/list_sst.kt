 ...
 * Use the [list_sst.newInstance] factory method to
 * create an instance of this fragment.
 */
class list_sst : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        //return inflater.inflate(R.layout.fragment_list_sst, container, false)
        return super.onCreateView(inflater, container, savedInstanceState)
    }

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        var b: AlertDialog.Builder = AlertDialog.Builder(active)
        var v:View?=activity?.layoutInflater?.inflate(R.layout.fragment_list_sst, null, false)

        inicializar(v)
        accionar()
        b.setView(v)
        this.rvv=v?.findViewById(R.id.recyclerViewListSST)
        ...
        try {
            ...
            val documentsSSTCollection = db.collection("SSTDocuments")
            documentsSSTCollection.get().addOnCompleteListener(OnCompleteListener <QuerySnapshot> { task ->
                if (task.isSuccessful) {
                    ...
                    val adapterRecycle=MyItemRecyclerSSTViewAdapter(docs!!)
    ...
    companion object {
         ...
         * @return A new instance of fragment list_sst.
         */
