 ...
 * Use the [listPlain.newInstance] factory method to
 * create an instance of this fragment.
 */
class listPlain : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //return inflater.inflate(R.layout.fragment_list_plain, container, false)
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        var v:View?=activity?.layoutInflater?.inflate(R.layout.fragment_list_plain, null, false)

        inicializar(v)
        accionar()
        b.setView(v)
        this.rvv=v?.findViewById(R.id.recyclerViewListPDF)
        ...
        try {
            ...
            val documentsPlainCollection = db.collection("plainPDFDocuments")
            documentsPlainCollection.get().addOnCompleteListener(OnCompleteListener<QuerySnapshot> { task ->
                if (task.isSuccessful) {
                    ...
                    val adapterRecycle=MyItemRecyclerPlainViewAdapter(docs!!)
    ...
    fun inicializar(view:View?){
        this.exitButton=view?.findViewById(R.id.exitButtonList)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment listPlain.
         */
